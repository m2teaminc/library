...
public class SpUtil {
    ...
    public static boolean getNoImageState() {
        return prefs.getBoolean(Constant.SP_NO_IMAGE, DEFAULT_NO_IMAGE);
    }

    public static void setNoImageState(boolean state) {
        prefs.edit().putBoolean(Constant.SP_NO_IMAGE, state).apply();
    }

    public static boolean getAutoCacheState() {
        return prefs.getBoolean(Constant.SP_AUTO_CACHE, DEFAULT_AUTO_SAVE);
    }

    public static void setAutoCacheState(boolean state) {
        prefs.edit().putBoolean(Constant.SP_AUTO_CACHE, state).apply();
    }
}
